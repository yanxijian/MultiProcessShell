...
namespace mps::tab_strip
{
									   ...
									   int inset, int minAmong, int insertAmong, int spacing = kTabSpacing)
	{
		...
		for (;;)
		{
			...
			{
				const int center = idealOtherCenterX(otherWidths, dragW, insertAmong, insertAmong - 1, spacing);
			...
			if (insertAmong < n)
			{
				const int center = idealOtherCenterX(otherWidths, dragW, insertAmong, insertAmong, spacing);
	...
	inline std::vector<int64_t> buildYieldOrder(const std::vector<int64_t>& others, int insertAmong, int64_t dragTabId)
	{
	...
	inline std::vector<int64_t> collapseSlotOrder(const std::vector<int64_t>& tabIds, int64_t dragTabId)
	{
