...
public:
  ...
  [[nodiscard]] int clientIndex() const { return clientIndex_; }
  [[nodiscard]] qint64 pageId() const { return pageId_; }
  [[nodiscard]] bool ready() const { return ready_; }
  [[nodiscard]] mps::ipc::EnvelopeChannel* channel() { return channel_.get(); }
